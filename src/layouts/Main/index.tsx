    ...
    <main className="main">
      ...
      <div className="frame">
        <Input
          ...
          tooltipText={
            !isMobileDevice
              ? 'Основная квартира: у заемщика нет квартиры ставка финансирования<br>Максимум до 75%<br><br>Альтернативная квартира: Для заемщика квартира, которую он обязуется продать в течение двух лет ставка финансирования<br>Максимум до 70%<br><br>Вторая квартира или выше: у заемщика уже есть ставка финансирования квартиры<br>Максимум до 50%'
              : ''
          }
          icon={CurrencyIcon}
        />
